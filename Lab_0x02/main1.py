...
def main():
    ...
    task1 = cotask.Task(UI_task, name="UI Task", priority=0, period=200, profile=True, trace=False, shares=(motor_eff, results, done, motor_speed_left, motor_speed_right, motor_time))
    ...
    task3 = cotask.Task(encoder_task, name="Encoder Task", priority=1, period=100, profile=True, trace=False, shares=(encoder_start, motor_speed_left, motor_speed_right, motor_time))
