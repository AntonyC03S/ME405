...
def main():
    ...
    task3 = cotask.Task(encoder_task, name="Encoder Task", priority=2, period=20, profile=True, trace=False, shares=(encoder_start, motor_speed_left, motor_speed_right, motor_position_left, motor_position_right, motor_time, done))
