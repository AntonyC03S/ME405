...
def main():
    ...
    data_sharing         = task_share.Share('f', thread_protect=False, name="UI to Motor Data sharing")
    ...
    task1 = cotask.Task(UI_task,      name="UI Task",      priority=0, period=200, profile=True, trace=False, shares=(motor_eff, results, done, motor_speed_left, motor_speed_right, motor_time, encoder_start, Kp, Ki, Kd,data_sharing))
    task2 = cotask.Task(motor_task,   name="Motor Task",   priority=3, period=50,  profile=True, trace=False, shares=(motor_eff, encoder_start, L_volt, R_volt, done, Kp, Ki, Kd,lspeed, rspeed,s,a,data_sharing))
